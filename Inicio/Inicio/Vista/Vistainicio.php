<head>
    <link rel="stylesheet" type="text/css" href="clases/html/css/paginador2.css">
</head>
<?php
...
class Inicio
{
    public function template($datos)
    {
        ...
        foreach ($datosPagina as $dato) {
            ...
            echo "<p>Apellido Materno: " . $dato->apm . "</p>";
            echo "<p>Apellido Paterno: " . $dato->app . "</p>";
            echo "<p>Telefono: " . $dato->telefono . "</p>";
            echo "<hr>";
        }
